        ...
        <div className="my-12">
            <div className="navbar p-0 bg-base-100">
                <div className="navbar-start">
                    ...
                    <a className="btn pl-0 btn-ghost text-3xl">Recipe Calories</a>
                </div>
                ...
                <div className=" navbar-end gap-4">
                    <label className="input input-bordered hidden md:flex lg:flex border-none rounded-r-full rounded-l-full bg-[#150B2B0D]  items-center gap-2">
                        ...
                        <input type="text" className="grow   font-extrabold" placeholder="Search"/>
                    </label>
                    <button className="text-3xl rounded-full p-2 bg-[#0BE58A]"><CgProfile /></button>
                </div>
            </div>
        </div>
    );
