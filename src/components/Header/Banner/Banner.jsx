            ...
            <div className="hero rounded-3xl bg-image">
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div>
                        ...
                        <p className="mb-5">Experience the delight of a customized cooking class, perfectly tailored to suit your palate. Uncover <br /> the joy of culinary exploration with our personalized sessions, curated just for you.</p>
